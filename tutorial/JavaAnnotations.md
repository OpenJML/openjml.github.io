...
Because of the above limitations and the fact that the Java source code is being modified by adding annotations like `@Pure`, these Java annotations for JML are less popular than simply using the JML annotation comments.
